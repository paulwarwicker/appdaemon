...
# from unittest import mock # pylint: disable=E0401 disable=E0611

import appdaemon.plugins.hass.hassapi as Hass # was h # pylint: disable=E0401 disable=E0611
...
# @freeze_time('2024-01-01')
# def test_is_bank_holiday2(hass_driver, lib: AutomationLib):

#     with hass_driver.setup():
#         hass_driver.set_state('input_boolean.mock_run', 'on')

#     assert datetime.datetime.now() == datetime.datetime(2024, 1, 1)
#     assert lib.is_bank_holiday()
