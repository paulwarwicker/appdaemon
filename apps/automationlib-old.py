...
class AutomationLib():
    ...
    def __init__(self, adapi: ADAPI) -> None:
        ...
        # self.debug = adapi.get_state('input_boolean.default_debug_state') == 'on'
        # self.verbose = adapi.get_state('input_boolean.default_verbose_state') == 'on'
        # self.testing = adapi.get_state('input_boolean.default_testing_state') == 'on'
        # self.trace = adapi.get_state('input_boolean.default_trace_state') == 'on'

        self.debug = self.adapi.args('debug', False)
        self.verbose = self.adapi.args('verbose', False)
        self.testing = self.adapi.args('testing', False)
        self.trace = self.adapi.args('trace', False)
