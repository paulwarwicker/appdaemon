...
# -----------------------------------------------------------------------------------
    ...
    def initialize(self):
        ...
        self.listen_state(self.max_location_detect, self.const.MAX_ENTITY_ID, old='C_R_T', location='proximity.c_r_t')
        self.listen_state(self.max_location_detect, self.const.MAX_ENTITY_ID, old='C_R_T_offsite', location='proximity.c_r_t_offsite')
        self.listen_state(self.max_location_detect, self.const.MAX_ENTITY_ID, old='Jan_Jim', location='proximity.jan_jim')
